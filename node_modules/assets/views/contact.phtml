...
*/
/*---------------------------------------------------------------*/?>
<section class="section--first" id="contact">
            ...
            <form name="contact_form" method="post" action="/contact">
                <table width="100%">
                    <tr>
                        ...
                        <td valign="top">
                            <input type="text" name="nom" maxlength="100" size="100" value="<?php if (isset($_POST['nom'])) echo htmlspecialchars($_POST['nom']);?>">
                        </td>
                    </tr>
                    <tr>
                        <td valign="top">
                        ...
                        <td valign="top">
                            <input type="text" name="prenom" maxlength="100" size="100" value="<?php if(isset($_POST['prenom'])) echo htmlspecialchars($_POST['prenom']);?>">
                        </td>
                    </tr>
                    <tr>
                        <td valign="top">
                        ...
                        <td valign="top">
                            <input  type="text" name="email" maxlength="100" size="100" value="<?php if(isset($_POST['email'])) echo htmlspecialchars($_POST['email']);?>">
                        </td>
                    </tr>
                    <tr>
                        <td valign="top">
                        ...
                        <td valign="top">
                            <input  type="text" name="telephone" maxlength="100" size="100" value="<?php if (isset($_POST['telephone'])) echo htmlspecialchars($_POST['telephone']);?>">
                        </td>
                    </tr>
                    <tr>
                        <td valign="top">
...
if(isset($_POST['email'])) {
    ...
    $email_to = "contact@alexisbeucher.fr";
...
'Le commentaire que vous avez entré ne semble pas être valide.<br />';
    ...
    <?php require './assets/views/includes/_aside.phtml'; ?>
</section>
